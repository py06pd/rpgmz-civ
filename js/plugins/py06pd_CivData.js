...
py06pd.CivData.Buildings = {
    barracks: { label: "Barracks", requires: "", construct: 40, maintain: 2, buildVeteran: true },
    aqueduct: { label: "Aqueduct", requires: "construction", construct: 120, maintain: 2 },
    bank: { label: "Bank", requires: "banking", requireBuilding: ["market"], construct: 120, maintain: 3, goldRate: 1.5, luxuryRate: 1.5 },
    cathedral: { label: "Cathedral", requires: "religion", construct: 160, maintain: 3, content: 4 },
    walls: { label: "City Walls", requires: "masonry", construct: 120, maintain: 2 },
    colosseum: { label: "Colosseum", requires: "construction", construct: 100, maintain: 4, content: 3 },
    courthouse: { label: "Courthouse", requires: "laws", construct: 80, maintain: 1 },
    factory: { label: "Factory", requires: "industry", construct: 200, maintain: 4, productionRate: 1.5 },
    granary: { label: "Granary", requires: "pottery", construct: 60, maintain: 1 },
    hydro: { label: "Hydro Plant", requires: "electronics", construct: 240, maintain: 4 },
    library: { label: "Library", requires: "writing", construct: 80, maintain: 1, scienceRate: 1.5 },
    market: { label: "Marketplace", requires: "currency", construct: 80, maintain: 1, goldRate: 1.5, luxuryRate: 1.5 },
    transit: { label: "Mass Transit", requires: "mass", construct: 160, maintain: 4 },
    mfg: { label: "Mfg. Plant", requires: "robotics", construct: 320, maintain: 6, productionRate: 2 },
    nuclear: { label: "Nuclear Plant", requires: "nuclear", construct: 160, maintain: 2 },
    palace: { label: "Palace", requires: "masonry", construct: 200, maintain: 0 },
    power: { label: "Power Plant", requires: "refining", requireBuilding: ["mfg", "factory"], construct: 160, maintain: 4, productionRate: 1.5 },
    recycling: { label: "Recycling Centre", requires: "recycling", construct: 200, maintain: 2 },
    sdi: { label: "SDI Defense", requires: "superconductor", construct: 200, maintain: 4 },
    temple: { label: "Temple", requires: "burial", construct: 40, maintain: 1, content: 1 },
    university: { label: "University", requires: "university", requireBuilding: ["library"], construct: 160, maintain: 3, scienceRate: 1.5 },
    apollo: { label: "Apollo Program", requires: "space", construct: 600, wonder: true },
    colossus: { label: "Colossus", requires: "bronze", construct: 200, wonder: true },
    copernicus: { label: "Copernicus' Observatory", requires: "astronomy", construct: 300, wonder: true },
    cancer: { label: "Cure for Cancer", requires: "genetics", construct: 600, wonder: true },
    darwon: { label: "Darwin's Voyage", requires: "railroad", construct: 300, wonder: true },
    glibrary: { label: "Great Library", requires: "literacy", construct: 300, wonder: true },
    gwall: { label: "Great Wall", requires: "masonry", construct: 300, wonder: true },
    gardens: { label: "Hanging Gardens", requires: "pottery", construct: 300, wonder: true },
    hoover: { label: "Hoover Dam", requires: "electronics", construct: 600, wonder: true },
    newton: { label: "Isaac Newton's College", requires: "gravity", construct: 400, wonder: true },
    bach: { label: "J.S. Bach's Cathedral", requires: "religion", construct: 400, wonder: true },
    lighthouse: { label: "Great Lighthouse", requires: "maps", construct: 200, wonder: true },
    magellan: { label: "Magellan's Expedition", requires: "navigation", construct: 400, wonder: true },
    manhattan: { label: "Manhattan Project", requires: "fission", construct: 600, wonder: true },
    michelangelo: { label: "Michelangelo's Chapel", requires: "religion", construct: 300, wonder: true },
    oracle: { label: "Oracle", requires: "mysticism", construct: 300, wonder: true },
    pyramids: { label: "Great Pyramid", requires: "masonry", construct: 300, wonder: true },
    seti: { label: "SETI Program", requires: "computers", construct: 600, wonder: true },
    globe: { label: "Globe Theatre", requires: "medicine", construct: 400, wonder: true },
    united: { label: "United Nations", requires: "communism", construct: 600, wonder: true },
    suffrage: { label: "Women's Suffrage", requires: "industry", construct: 600, wonder: true }
};
...
py06pd.CivData.Units = [
    { name: "settler", label: "Settler", requires: "", characterIndex: 5, characterName: "Vehicle", attack: 0, defence: 1, move: 1, construct: 40, buildRoads: true, buildMines: true, buildIrrigation: true, buildFortresses: true, cleanPollution: true, buildCity: true, populationCost: 1 },
    { name: "militia", label: "Militia", requires: "", characterIndex: 2, characterName: "People1", attack: 1, defence: 1, move: 1, construct: 10, obsolete: "gunpowder" },
    { name: "cavalry", label: "Cavalry", requires: "horseback", characterIndex: 2, characterName: "People4", attack: 2, defence: 1, move: 2, construct: 20, obsolete: "conscription" },
    { name: "legion", label: "Legion", requires: "iron", characterIndex: 6, characterName: "People4", attack: 3, defence: 1, move: 3, construct: 20, obsolete: "conscription" },
    { name: "phalanx", label: "Phalanx", requires: "bronze", characterIndex: 4, characterName: "People1", attack: 1, defence: 2, move: 1, construct: 20, obsolete: "gunpowder" },
    { name: "diplomat", label: "Diplomat", requires: "writing", characterIndex: 5, characterName: "People3", attack: 0, defence: 0, move: 2, construct: 30, ignoreAdjacent: true },
    { name: "musketeer", label: "Musketeer", requires: "gunpowder", characterIndex: 4, characterName: "Actor2", attack: 2, defence: 3, move: 1, construct: 30, obsolete: "conscription" },
    { name: "rifleman", label: "Rifleman", requires: "conscription", characterIndex: 4, characterName: "Actor1", attack: 3, defence: 5, move: 1, construct: 30 },
    { name: "cannon", label: "Cannon", requires: "metallurgy", characterIndex: 2, characterName: "Actor1", attack: 8, defence: 1, move: 1, construct: 40, obsolete: "robotics" },
    { name: "catapult", label: "Catapult", requires: "mathematics", characterIndex: 6, characterName: "Actor1", attack: 6, defence: 1, move: 1, construct: 40, obsolete: "metallurgy" },
    { name: "chariot", label: "Chariot", requires: "wheel", characterIndex: 4, characterName: "Vehicle", attack: 4, defence: 1, move: 2, construct: 40, obsolete: "chivalry" },
    { name: "knight", label: "Knight", requires: "chivalry", characterIndex: 6, characterName: "Actor3", attack: 4, defence: 2, move: 2, construct: 40, obsolete: "automobile" },
    { name: "caravan", label: "Caravan", requires: "trade", characterIndex: 4, characterName: "People4", attack: 0, defence: 1, move: 1, construct: 50, ignoreAdjacent: true, tradeRoutes: true },
    { name: "mech", label: "Mech. Infantry", requires: "unions", characterIndex: 0, characterName: "SF_Vehicle", attack: 6, defence: 6, move: 3, construct: 50 },
    { name: "artillery", label: "Artillery", requires: "robotics", characterIndex: 3, characterName: "SF_Vehicle", attack: 12, defence: 2, move: 2, construct: 60, ignoreWalls: true },
    { name: "armour", label: "Armour", requires: "automobile", characterIndex: 6, characterName: "SF_Vehicle", attack: 10, defence: 5, move: 3, construct: 80 },
    { name: "trireme", label: "Trireme", requires: "maps", characterIndex: 0, characterName: "Vehicle", attack: 1, defence: 0, move: 3, construct: 40, sea: true, cargo: 2 },
    { name: "sail", label: "Sail", requires: "navigation", characterIndex: 7, characterName: "Vehicle", attack: 1, defence: 1, move: 3, construct: 40, sea: true, cargo: 3 },
    { name: "frigate", label: "Frigate", requires: "magnetism", characterIndex: 1, characterName: "Vehicle", attack: 2, defence: 2, move: 3, construct: 40, sea: true, cargo: 4 },
    { name: "transport", label: "Transport", requires: "industry", characterIndex: 7, characterName: "SF_Vehicle", attack: 0, defence: 3, move: 4, construct: 50, sea: true, cargo: 8 },
    { name: "submarine", label: "Submarine", requires: "mass", characterIndex: 3, characterName: "Vehicle", attack: 8, defence: 2, move: 3, construct: 50, sea: true, sight: 2, cannotAttackLand: true, invisibleOnLand: true, onlyVisibleAdjacent: true },
    { name: "ironclad", label: "Ironclad", requires: "steam", characterIndex: 7, characterName: "SF_Vehicle", attack: 4, defence: 4, move: 4, construct: 60, sea: true, obsolete: "combustion" },
    { name: "cruiser", label: "Cruiser", requires: "combustion", characterIndex: 3, characterName: "Vehicle", attack: 6, defence: 6, move: 6, construct: 80, sea: true, sight: 2 },
    { name: "carrier", label: "Carrier", requires: "advanced", characterIndex: 3, characterName: "Vehicle", attack: 1, defence: 12, move: 5, construct: 160, sea: true, sight: 2, airCargo: 8 },
    { name: "battleship", label: "Battleship", requires: "steel", characterIndex: 3, characterName: "Vehicle", attack: 18, defence: 12, move: 4, construct: 160, sea: true, sight: 2 },
    { name: "fighter", label: "Fighter", requires: "flight", characterIndex: 2, characterName: "SF_Vehicle", attack: 4, defence: 2, move: 10, construct: 60, air: true },
    { name: "bomber", label: "Bomber", requires: "advanced", characterIndex: 2, characterName: "SF_Vehicle", attack: 12, defence: 1, move: 8, construct: 120, air: true, ignoreWalls: true, sight: 2, attackEndsTurn: true },
    { name: "nuclear", label: "Nuclear", requires: "rocketry", characterIndex: 2, characterName: "SF_Vehicle", attack: 99, defence: 0, move: 16, construct: 160, air: true, invisibleUntilAttack: true, ignoreZoneControl: true, causeLandPollution: true, wonder: "manhattan" }
];
