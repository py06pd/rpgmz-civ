...
py06pd.CivData.Buildings = {
    barracks: { label: "Barracks", requires: "", construct: 40, maintain: 2, buy: 160, sell: 40 },
    aqueduct: { label: "Aqueduct", requires: "construction", construct: 120, maintain: 2, buy: 480, sell: 120  },
    bank: { label: "Bank", requires: "banking", construct: 120, maintain: 3, buy: 480, sell: 120 },
    cathedral: { label: "Cathedral", requires: "religion", construct: 160, maintain: 3, buy: 640, sell: 160 },
    walls: { label: "City Walls", requires: "masonry", construct: 120, maintain: 2, buy: 480, sell: 120 },
    colosseum: { label: "Colosseum", requires: "construction", construct: 100, maintain: 4, buy: 400, sell: 100 },
    courthouse: { label: "Courthouse", requires: "laws", construct: 80, maintain: 1, buy: 320, sell: 80 },
    factory: { label: "Factory", requires: "industry", construct: 200, maintain: 4, buy: 800, sell: 200 },
    granary: { label: "Granary", requires: "pottery", construct: 60, maintain: 1, buy: 240, sell: 60 },
    hydro: { label: "Hydro Plant", requires: "electronics", construct: 240, maintain: 4, buy: 960, sell: 240 },
    library: { label: "Library", requires: "writing", construct: 80, maintain: 1, buy: 320, sell: 80 },
    market: { label: "Marketplace", requires: "currency", construct: 80, maintain: 1, buy: 320, sell: 80 },
    transit: { label: "Mass Transit", requires: "mass", construct: 160, maintain: 4, buy: 640, sell: 160 },
    mfg: { label: "Mfg. Plant", requires: "robotics", construct: 320, maintain: 6, buy: 1280, sell: 320 },
    nuclear: { label: "Nuclear Plant", requires: "nuclear", construct: 160, maintain: 2, buy: 640, sell: 160 },
    palace: { label: "Palace", requires: "masonry", construct: 200, maintain: 0, buy: 800, sell: 200 },
    power: { label: "Power Plant", requires: "refining", construct: 160, maintain: 4, buy: 640, sell: 160 },
    recycling: { label: "Recycling Centre", requires: "recycling", construct: 200, maintain: 2, buy: 800, sell: 200 },
    sdi: { label: "SDI Defense", requires: "superconductor", construct: 200, maintain: 4, buy: 800, sell: 200 },
    temple: { label: "Temple", requires: "burial", construct: 40, maintain: 1, buy: 160, sell: 40 },
    university: { label: "University", requires: "university", construct: 160, maintain: 3, buy: 640, sell: 160 },
