...
py06pd.CivData.Buildings = {
    barracks: { label: "Barracks", requires: "", construct: 40, maintain: 2 },
    aqueduct: { label: "Aqueduct", requires: "construction", construct: 120, maintain: 2  },
    bank: { label: "Bank", requires: "banking", construct: 120, maintain: 3 },
    cathedral: { label: "Cathedral", requires: "religion", construct: 160, maintain: 3 },
    walls: { label: "City Walls", requires: "masonry", construct: 120, maintain: 2 },
    colosseum: { label: "Colosseum", requires: "construction", construct: 100, maintain: 4 },
    courthouse: { label: "Courthouse", requires: "laws", construct: 80, maintain: 1 },
    factory: { label: "Factory", requires: "industry", construct: 200, maintain: 4 },
    ...
    library: { label: "Library", requires: "writing", construct: 80, maintain: 1 },
    market: { label: "Marketplace", requires: "currency", construct: 80, maintain: 1 },
    transit: { label: "Mass Transit", requires: "mass", construct: 160, maintain: 4 },
    mfg: { label: "Mfg. Plant", requires: "robotics", construct: 320, maintain: 6 },
    ...
    power: { label: "Power Plant", requires: "refining", construct: 160, maintain: 4 },
    ...
    temple: { label: "Temple", requires: "burial", construct: 40, maintain: 1 },
    university: { label: "University", requires: "university", construct: 160, maintain: 3 },
